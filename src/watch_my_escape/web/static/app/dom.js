...
export function getDomRefs() {
  ...
  return {
    ...
    modelSettingsToggle: query("#model-settings-toggle"),
    modelAdvancedSettings: query("#model-advanced-settings"),
    modelThinkingToggle: query("#model-thinking-toggle"),
    modelTemperatureDown: query("#model-temperature-down"),
    modelTemperatureUp: query("#model-temperature-up"),
    modelTemperatureValue: query("#model-temperature-value"),
    ...
    warmupModel: query("#warmup-model"),
    warmupProgress: query("#warmup-progress"),
    warmupStatus: query("#warmup-status"),
    ...
    escapeResultIcon: query("#escape-result-icon"),
    escapeResultMessage: query("#escape-result-message"),
